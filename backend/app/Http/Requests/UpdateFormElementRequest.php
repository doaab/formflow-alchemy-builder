...
class UpdateFormElementRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'element_id' => [
                ...
                'required',
                'string',
                Rule::unique('form_elements', 'element_id')->ignore($this->route('element')),
            ],
            'type' => ['sometimes', 'required', 'string', new ValidQuestionType],
